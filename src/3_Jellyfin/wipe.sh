#!/usr/bin/env bash
set -euo pipefail
# CONTROL_HEADER: Service 3 - C.O.R.E Jellyfin Wipe (jellyfin.core)
...
confirm() {
  ...
  echo "This will remove Jellyfin runtime artifacts, ingress config, and optionally purge installed packages."
...
sudo rm -f /var/log/nginx/core-jellyfin.access.log /var/log/nginx/core-jellyfin.error.log
