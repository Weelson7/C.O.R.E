#!/usr/bin/env bash
set -euo pipefail
# CONTROL_HEADER: Service 13 - C.O.R.E ncdu-web-viewer Wipe (ncdu.core)
...
log() {
  echo "[core-ncdu-web-viewer:wipe] $*"
}
...
confirm() {
  ...
  echo "This will remove ncdu-web-viewer runtime artifacts, ingress config, container assets, and optional packages."
...
sudo rm -f /var/log/nginx/core-ncdu-web-viewer.access.log /var/log/nginx/core-ncdu-web-viewer.error.log
