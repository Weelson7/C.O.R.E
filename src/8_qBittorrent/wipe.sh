...
confirm() {
  ...
  echo "This will remove qBittorrent runtime artifacts, ingress config, and optionally purge installed packages."
...
sudo rm -f /var/log/nginx/core-qbittorrent.access.log /var/log/nginx/core-qbittorrent.error.log
