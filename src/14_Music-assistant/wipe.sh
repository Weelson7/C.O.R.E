#!/usr/bin/env bash
set -euo pipefail
# CONTROL_HEADER: Service 14 - C.O.R.E Music Assistant Wipe (music.core)
...
log() {
  echo "[core-music-assistant:wipe] $*"
}
...
confirm() {
  ...
  echo "This will remove Music Assistant runtime artifacts, ingress config, container assets, and optional packages."
...
sudo rm -f /var/log/nginx/core-music-assistant.access.log /var/log/nginx/core-music-assistant.error.log
